    ...
    <div className="formContainer">
      ...
      <form
        ...
        <div className="space-y-2">
          ...
          />
          {errors.name && (
            <span className="text-red-500">This product name is required</span>
          )}
        </div>
        <div className="space-y-2">
        ...
        <div className="space-y-2">
          ...
          />
          {errors.imageUrl && (
            <span className="text-red-500">This image url is required</span>
          )}
        </div>
        <div className="grid grid-cols-2 gap-8 pb-4">
          ...
          <div className="space-y-2">
            ...
            />
            {errors.quantity && (
              <span className="text-red-500">This quantity is required</span>
            )}
          </div>
        </div>
